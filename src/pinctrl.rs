...
pub const PIN_SPIM1_MUX1: PinctrlPin = PinctrlPin {
    offset: 0x410,
    bit: 12,
    clear: true,
};

pub const PIN_SPIM1_MUX13: PinctrlPin = PinctrlPin {
    offset: 0x4B0,
    bit: 12,
    clear: true,
};
pub const PIN_SPIM1_MUX31: PinctrlPin = PinctrlPin {
    offset: 0x690,
    bit: 12,
    clear: false,
};

pub const PIN_SPIM2_MUX1: PinctrlPin = PinctrlPin {
    offset: 0x410,
    bit: 26,
    clear: true,
};

pub const PIN_SPIM2_MUX13: PinctrlPin = PinctrlPin {
    offset: 0x4B0,
    bit: 26,
    clear: true,
};

pub const PIN_SPIM2_MUX31: PinctrlPin = PinctrlPin {
    offset: 0x690,
    bit: 26,
    clear: false,
};

pub const PIN_SPIM3_MUX2: PinctrlPin = PinctrlPin {
    offset: 0x414,
    bit: 8,
    clear: true,
};

pub const PIN_SPIM3_MUX14: PinctrlPin = PinctrlPin {
    offset: 0x4B4,
    bit: 8,
    clear: true,
};

pub const PIN_SPIM3_MUX32: PinctrlPin = PinctrlPin {
    offset: 0x694,
    bit: 8,
    clear: false,
};

pub const PIN_SPIM4_MUX2: PinctrlPin = PinctrlPin {
    offset: 0x414,
    bit: 22,
    clear: true,
};

pub const PIN_SPIM4_MUX14: PinctrlPin = PinctrlPin {
    offset: 0x4B4,
    bit: 22,
    clear: true,
};

pub const PIN_SPIM4_MUX32: PinctrlPin = PinctrlPin {
    offset: 0x694,
    bit: 22,
    clear: false,
};
...
pub const PINCTRL_SPIM1_MUXSEL: &[PinctrlPin] = &[PIN_SPIM1_MUX1, PIN_SPIM1_MUX13, PIN_SPIM1_MUX31];
pub const PINCTRL_SPIM2_MUXSEL: &[PinctrlPin] = &[PIN_SPIM2_MUX1, PIN_SPIM2_MUX13, PIN_SPIM2_MUX31];
pub const PINCTRL_SPIM3_MUXSEL: &[PinctrlPin] = &[PIN_SPIM3_MUX2, PIN_SPIM3_MUX14, PIN_SPIM3_MUX32];
pub const PINCTRL_SPIM4_MUXSEL: &[PinctrlPin] = &[PIN_SPIM4_MUX2, PIN_SPIM4_MUX14, PIN_SPIM4_MUX32];
